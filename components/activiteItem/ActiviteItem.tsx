...
const ActiviteItem = ({ activite, premier }: { activite: Activite, premier: boolean }) => {
  ...
  return (
    <div  className={`${styles.hexagon} ${!premier ? styles.dernier : ""}`} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      <img src={activite.imageLien} className={styles.svg} />
